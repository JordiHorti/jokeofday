 ...
 */
    ...
    return /** @alias module:core/ajax */ {
         ...
         * @param {{args: {methodname: string, userid: (*|jQuery), jokeid: (*|jQuery), score: (*|jQuery|string), joke: (*|jQuery),
         * timecreated: string}}} requests Array of requests with each containing methodname and args properties.
