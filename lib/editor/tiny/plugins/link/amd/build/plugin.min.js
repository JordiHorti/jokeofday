...
/**
   ...
   */}Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.default=void 0,Commands=_interopRequireWildcard(Commands),Configuration=_interopRequireWildcard(Configuration),Options=_interopRequireWildcard(Options);var _default=new Promise((async resolve=>{const[tinyMCE,setupCommands,pluginMetadata]=await Promise.all([(0,_loader.getTinyMCE)(),Commands.getSetup(),(0,_utils.getPluginMetadata)(_common.component,_common.pluginName)]);tinyMCE.PluginManager.add(`${_common.component}/plugin`,(editor=>(Options.register(editor),setupCommands(editor),pluginMetadata))),resolve([`${_common.component}/plugin`,Configuration])}));return _exports.default=_default,_exports.default}));
