...
/**
 * Given an ID of an instance of this module,
 * this function will get score of jokes
 *
 * @global object
 * @param int $id
 * @return object
 */
function jokeofday_get_score(int $id) {
    global $DB;

    $joke_score = $DB->get_record('jokeofday_joke', ['id' => $id]);

    $result = new stdClass();
    $result->joke_id = $joke_score->id;
    $result->joke = $joke_score->joke;
